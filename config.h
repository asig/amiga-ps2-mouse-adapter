...
// Uncomment the following #define to see mouse adapter specific debug
// info in the serial console
// #define DEBUG

// Uncomment the following #define to see PS/2 specific debugging info
